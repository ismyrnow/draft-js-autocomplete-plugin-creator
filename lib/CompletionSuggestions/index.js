...
exports.default = function (addModifier, Entry, suggestionsThemeKey, selectionPredicate) {
  var _class, _temp2;
    ...
    function CompletionSuggestions() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CompletionSuggestions.__proto__ || Object.getPrototypeOf(CompletionSuggestions)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        var selectionIsInsideWord = leaves.filter(function (leave) {
          ...
          return selectionPredicate({ start: start, end: end, anchorOffset: anchorOffset });
        });
    ...
    _createClass(CompletionSuggestions, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            elementProps = _objectWithoutProperties(_props, ['onSearchChange', 'suggestions', 'ariaProps', 'callbacks', 'theme', 'store', 'entityMutability', 'positionSuggestions']);
