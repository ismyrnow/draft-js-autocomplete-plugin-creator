...
exports.getSearchText = exports.defaultSuggestionsFilter = undefined;
...
var _defaultSelectionPredicate = require('./utils/defaultSelectionPredicate');

var _defaultSelectionPredicate2 = _interopRequireDefault(_defaultSelectionPredicate);
...
var createCompletionPlugin = function createCompletionPlugin(completionSuggestionsStrategy, addModifier, SuggestionEntry) {
  ...
  var selectionPredicate = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : _defaultSelectionPredicate2.default;
  return function () {
    ...
    var CompletionSuggestions = (0, _CompletionSuggestions2.default)(addModifier, SuggestionEntry, suggestionsThemeKey, selectionPredicate);
    return {
...
exports.getSearchText = _getSearchText3.default;